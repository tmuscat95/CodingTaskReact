...
I originally planned to do it in vanilla Javascript but started to get stuck as I have not done frontend code outside of a framework in a very long time
...
Please excuse also the inconsistent use of fetch and axios and functional/class-based React components; I realised only near the end and decided I'd better just submit and not take anymore time rather than go back and fix it.
